...
<nav class="dark:bg-gray-800 light:bg-white border-b">
      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            <button
              class="px-3 py-2 rounded-md text-sm font-medium {$currentEvent ? 'text-gray-300 hover:bg-gray-700 hover:text-white' : 'bg-gray-900 text-white'}"
              on:click={returnHome}>Home</button>
            <button
              class="px-3 py-2 rounded-md text-sm font-medium {$currentEvent ? 'bg-gray-900 text-white' : 'text-gray-300'}"
              on:click={() => (settings = false)}>Timer</button>
          </div>
        </div>
      </div>
      <div class="hidden md:block">
  ...
  <div class="hidden md:hidden">
    <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
      ...
      <a
        href="#"
        class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Timer</a>
    </div>
